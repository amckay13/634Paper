...
\title{DRuby Replication Study}

\author{
	Cameron Moy, Ben Mariano, Alex McKay
...
% The recruitment survey and interview protocol are included as appendices
\appendices
\input{experiment_protocol}
\input{interview_protocol}
\input{demographic_protocol}
